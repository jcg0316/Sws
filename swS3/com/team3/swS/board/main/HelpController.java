...
public class HelpController {
    ...
    void MouseClickTable(MouseEvent event) {
    	try {
    		...
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../view/HelpRead.fxml"));
    		Parent popRoot = loader.load();
    		
    		HelpReadController helpRead = loader.getController();
    		helpRead.setHc(this);
    ...
    void btnSearchOk(ActionEvent event) {
    	...
    	if(menubtn.getText().equals("작성자")) {
    		...
    		List<BoardVO> mbjl = service.getAllBoard_Writer_C(bd);
    		boardList.clear();
    		...
    		List<BoardVO> mbjl = service.getAllBoard_Contents_C(bd);
    		boardList.clear();
    		boardList.addAll(mbjl);
    		tableviewInfo.setItems(boardList);
    		...
    		List<BoardVO> mbjl = service.getAllBoard_Title_C(bd);
    		boardList.clear();
    		boardList.addAll(mbjl);
    		tableviewInfo.setItems(boardList);
    ...
    void btnWrite(ActionEvent event) {
    	try {
    		Parent popRoot = FXMLLoader.load(getClass().getResource("../view/HelpWrite.fxml"));
    		Stage primaryStage = new Stage(StageStyle.UTILITY);
    		primaryStage.initModality(Modality.WINDOW_MODAL);
    		primaryStage.initOwner(swMainMain.rootStage);
    		Scene scene = new Scene(popRoot);
    		...
    		boardList.clear();
    		boardList.addAll(service.getAllBoard_B());
    		init();
    ...
    @FXML
    void initialize() {
    	assert tableviewInfo != null : "fx:id=\"tableviewInfo\" was not injected: check your FXML file 'help.fxml'.";
        assert colunmNo != null : "fx:id=\"colunmNo\" was not injected: check your FXML file 'help.fxml'.";
        assert colunmTitle != null : "fx:id=\"colunmTitle\" was not injected: check your FXML file 'help.fxml'.";
        assert colunmDate != null : "fx:id=\"colunmDate\" was not injected: check your FXML file 'help.fxml'.";
        assert colunmNick != null : "fx:id=\"colunmNick\" was not injected: check your FXML file 'help.fxml'.";
        assert pagePanel != null : "fx:id=\"pagePanel\" was not injected: check your FXML file 'help.fxml'.";
        assert noticePagination != null : "fx:id=\"noticePagination\" was not injected: check your FXML file 'help.fxml'.";
        assert btnWrite != null : "fx:id=\"btnWrite\" was not injected: check your FXML file 'help.fxml'.";
        assert menubtn != null : "fx:id=\"menubtn\" was not injected: check your FXML file 'help.fxml'.";
        assert menubtnNick != null : "fx:id=\"menubtnNick\" was not injected: check your FXML file 'help.fxml'.";
        assert menubtnText != null : "fx:id=\"menubtnText\" was not injected: check your FXML file 'help.fxml'.";
        assert menubtnTitle != null : "fx:id=\"menubtnTitle\" was not injected: check your FXML file 'help.fxml'.";
        assert txtFSearch != null : "fx:id=\"txtFSearch\" was not injected: check your FXML file 'help.fxml'.";
        assert btnSearchOk != null : "fx:id=\"btnSearchOk\" was not injected: check your FXML file 'help.fxml'.";
