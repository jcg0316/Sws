...
public class LVocaExcelReader {
	
	
	@SuppressWarnings("resource")
    public List<VocaVO> xlsToLVocaVoList(String filePath) {
        
        // 반환할 객체를 생성
        List<VocaVO> list = new ArrayList<VocaVO>();
...
//                }
     ...
     * @return
     */
    public List<VocaVO> xlsxToLVocaVoList(String filePath) {
        // 반환할 객체를 생성
        List<VocaVO> list = new ArrayList<VocaVO>();
            ...
            for(int sheetIndex = 0 ; sheetIndex < workbook.getNumberOfSheets(); sheetIndex++) {
                ...
                for(int rowIndex=0; rowIndex < curSheet.getPhysicalNumberOfRows(); rowIndex++) {
                    ...
                    if(rowIndex != 0) {
                        ...
                        String value;
                        int num = 0;
//                        System.out.println("1 ==> " + curRow.getCell(0) + "|");
//                        System.out.println("2 ==> " + curRow.getCell(1).getStringCellValue() + "|");
                        // row의 첫번째 cell값이 비어있지 않은 경우 만 cell탐색
//                        if(!"".equals(curRow.getCell(0).getStringCellValue())) {
                        	//if("".equals(curRow.getCell(0).getStringCellValue())) {
