...
public class HelpReadController {
	
	private HelpController hc;

	public void setHc(HelpController hc) {
		this.hc = hc;
	}
    ...
    @FXML
    void initialize() {
        assert txtFTitle != null : "fx:id=\"txtFTitle\" was not injected: check your FXML file 'helpRead.fxml'.";
        assert txtAInfo != null : "fx:id=\"txtAInfo\" was not injected: check your FXML file 'helpRead.fxml'.";
        assert btnModify != null : "fx:id=\"btnModify\" was not injected: check your FXML file 'helpRead.fxml'.";
        assert btnDelete != null : "fx:id=\"btnDelete\" was not injected: check your FXML file 'helpRead.fxml'.";
...
//        }
        ...
        if(Session.memJoin.getMem_author().equals("M")) {
        	btnModify.setVisible(false);
        	btnDelete.setVisible(false);
