...
public class NoticeWriteController {
    ...
    @FXML
    void initialize() {
        assert txtFTitle != null : "fx:id=\"txtFTitle\" was not injected: check your FXML file 'noticeWrite.fxml'.";
        assert txtAInfo != null : "fx:id=\"txtAInfo\" was not injected: check your FXML file 'noticeWrite.fxml'.";
        assert btnOk != null : "fx:id=\"btnOk\" was not injected: check your FXML file 'noticeWrite.fxml'.";
        assert btnCancel != null : "fx:id=\"btnCancel\" was not injected: check your FXML file 'noticeWrite.fxml'.";
